...
class rideclasses{
    ...
    public function insert_ride($from,$to,$total_distance, $luggage, $total_fare, $cab_data, $cust_id) {
        $sql = "INSERT INTO ride (`ride_date`,`loc_from`,`loc_to`,`total_distance`,`luggage`,`total_fare`,`cab_type`,`cust_id`) VALUES ( NOW(),'$from','$to','$total_distance', '$luggage', '$total_fare','$cab_data','$cust_id')"; 

  ...
  <body>
    <div class="container-fluid">       
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light  sticky">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <li class="nav-item active mr-5">
                            <a class="nav-link btn btn-outline-secondary mr-2" href="user_dashboard.php">Home<span class="sr-only">(current)</span></a>
                        </li>
                        <?php 
                        ...
                        ?>
                            <b> Hello Mr . <?php echo $third_menu; ?></b>
        ...
        <div class="mini-head-content container-fluid">
            You can easly book your ride in a soft manner in here
        </div>
        <div class="row">
